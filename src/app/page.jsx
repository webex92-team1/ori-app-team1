      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white/80 backdrop-blur-md">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button variant="ghost" asChild className="text-slate-600 hover:text-orange-500">
        ...
        <section className="relative py-20 md:py-32 overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center max-w-3xl">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 mb-6 leading-tight">
              冷蔵庫の<span className="text-orange-500">余り物</span>で、<br />
              今日のごはんが決まる。
            </h1>
            <p className="text-lg md:text-xl text-slate-600 mb-10 leading-relaxed">
              家にある食材を入力するだけで、最適なレシピをAIが提案。<br className="hidden md:block" />
              食材ロスを減らして、毎日の料理をもっと楽しく。
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button asChild size="lg" className="w-full sm:w-auto bg-orange-500 hover:bg-orange-600 text-white text-lg px-8 py-6 rounded-full shadow-lg hover:shadow-xl transition-all">
                <Link href="/signup">
                  無料で始める <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="w-full sm:w-auto border-slate-300 text-slate-700 hover:bg-slate-100 text-lg px-8 py-6 rounded-full">
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-slate-900 mb-4">FoodMatchでできること</h2>
              <p className="text-slate-500">3つのステップで、あなたの料理ライフをサポートします</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <Card className="border-none shadow-md bg-slate-50 hover:shadow-lg transition-shadow">
                <CardContent className="pt-6 text-center flex flex-col items-center">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-slate-800">食材を入力</h3>
              ...
              <Card className="border-none shadow-md bg-slate-50 hover:shadow-lg transition-shadow">
                <CardContent className="pt-6 text-center flex flex-col items-center">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-slate-800">レシピを提案</h3>
                  <p className="text-slate-600 leading-relaxed">
              ...
              <Card className="border-none shadow-md bg-slate-50 hover:shadow-lg transition-shadow">
                <CardContent className="pt-6 text-center flex flex-col items-center">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-slate-800">履歴・お気に入り</h3>
                  <p className="text-slate-600 leading-relaxed">
        ...
        <section className="py-20 bg-slate-50 overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-end mb-10">
              <div>
                <h2 className="text-3xl font-bold text-slate-900 mb-2">人気のレシピ</h2>
            ...
            <ScrollArea className="w-full whitespace-nowrap pb-4">
              <div className="flex w-max space-x-4 p-1">
                {popularRecipes.map((recipe) => (
                  <Card key={recipe.recipeId} className="w-[280px] md:w-[320px] shrink-0 overflow-hidden border-none shadow-md hover:shadow-xl transition-all duration-300 group cursor-pointer bg-white">
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center gap-2 mb-2">
                        <Badge variant="secondary" className="bg-orange-100 text-orange-700 hover:bg-orange-100 text-[10px]">
                          {recipe.recipeCost}
                        </Badge>
                      </div>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="bg-orange-500 rounded-3xl p-10 md:p-16 text-white shadow-xl max-w-4xl mx-auto relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <Button asChild size="lg" className="bg-white text-orange-600 hover:bg-slate-100 text-lg px-10 py-6 rounded-full shadow-lg">
